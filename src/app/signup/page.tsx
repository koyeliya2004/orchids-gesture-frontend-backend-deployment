...
import { Mail, Lock, User, ArrowRight, Loader2, Hand, Sparkles } from 'lucide-react';
        ...
        <div className="relative overflow-hidden rounded-3xl">
          ...
          <div className="relative p-10">
            <div className="text-center mb-10">
              ...
              <p className="text-white/40">Start detecting hand gestures today</p>
            </div>
            ...
            <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-white/30 mt-2 ml-1">Must be at least 6 characters</p>
              </div>
